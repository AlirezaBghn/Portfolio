...
const aboutText = `
Hi, I’m Alireza Baghban, a passionate and detail-oriented Full Stack Developer with expertise in building dynamic, responsive, and user-friendly web applications.
    ...
    front-end technologies like Tailwind CSS, JavaScript, HTML, and CSS, ensuring visually appealing and efficient designs. With a strong foundation in problem-solving and
    a commitment to clean, maintainable code, I thrive on solving complex problems and delivering high-quality digital experiences. Let’s build something amazing together!
`;
    ...
    <Section className="relative py-10">
      <div className="flex max-mobile-lg:flex-col-reverse justify-start items-stretch gap-2 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col">
            <span>Alireza.Baghbann@gmail.com</span>
      ...
      <div className="py-5">
          ...
          <div className="flex gap-2">
            <div className="border-l-4 border-primary pl-2">
              ...
              <span className="flex items-center gap-2">
                <HugeiconsUniversity /> WBS Coding School
              </span>
            </div>
          </div>
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.1 }}
          transition={{ duration: 0.6, ease: "easeOut", delay: 0.4 }}
          className="flex max-mobile-lg:flex-col justify-between bg-card p-4 border border-border rounded-lg mt-4"
        >
          <div className="flex gap-2">
            <div className="border-l-4 border-primary pl-2">
              <h3>Bachelor - Business Administration</h3>
              <span className="flex items-center gap-2">
                <HugeiconsUniversity /> University of Applied Science and
                Technology - Allameh Tabarsi Center, Tehran
              </span>
            </div>
          </div>
          <div className="max-mobile-lg:mt-2">
            <span>Mar 2011 - Feb 2014</span>
          </div>
        </motion.div>
      </div>
